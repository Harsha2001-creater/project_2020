...
class Stddetail(models.Model):
    ...
    SscDoc=models.ImageField(upload_to="doc")
    ...
    IntDoc=models.FileField(upload_to='docs/')
    ...
    UniDoc=models.FileField(upload_to='docs/')
    ...
    Uploadeng=models.FileField(upload_to='docs/')
    ...
    Uploadeng1=models.FileField(upload_to='docs/')
    ...
    Uploadad=models.FileField(upload_to='docs/')
    ...
    Uploadad1=models.FileField(upload_to='docs/')
